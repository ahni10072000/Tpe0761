        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-3">
                    <div class="shop__sidebar">
                        <div class="sidebar__categories">
                         <?php
                    	$id=$_GET['id'];
                     	$q=mysqli_query($koneksi, "SELECT*FROM  tbk_kategori where id_kat='$id'");
                    	while ($r=mysqli_fetch_array($q)) {
                    	?>
                            <div class="section-title">
                                <h4><?php echo $r['nama_kat']; ?></h4>
                            </div>
                         <?php } ?>
                                ...
                                <div class="accordion" id="accordionExample">
                                    <div class="card">
                                        ...
                                        <div class="card-heading active">
                                            <a data-toggle="collapse" data-target="#collapseOne">Styles</a>
                                        </div>
                                     
                                        <div id="collapseOne" class="collapse show" data-parent="#accordionExample">
                                            <div class="card-body">
                                            <?php $q=mysqli_query($koneksi,"SELECT* FROM tbl_style ");
                                            while($r=mysqli_fetch_array($q)){
                                            ?>
                                                <ul>
                                                    <li><a href="#"><?php echo $r['nama_style']?></a></li>
                ...
                <div class="col-lg-9 col-md-9">
                    ...
                    <?php
                     $id=$_GET['id'];
                     $q=mysqli_query($koneksi, "SELECT*FROM  tbl_produk where id_kat='$id'");
                     while ($r=mysqli_fetch_array($q)) {
                    ?>
                            ...
                            <div class="product__item">
                                <div class="product__item__pic set-bg" data-setbg="upload/<?php echo $r['gambar']?>">
                                    ...
                                    <ul class="product__hover">
                                        <li><a href="upload/<?php echo $r['gambar']?>" class="image-popup"><span class="arrow_expand"></span></a></li>
